...
doc: Align FASTQ files to a reference genome using the Burrows-Wheeler Aligner software (bwa mem). This is designed for paired-end reads stored in two separate FASTQ files.
requirements:
...
inputs:
  ...
  read_group_string:
    type: string
    doc: |
      This argument allows you to specify read-group information during alignment. Please specify the whole read-group string, including the @RG prefix, surround in quotes. You can find a helpful tutorial here: https://software.broadinstitute.org/gatk/documentation/article.php?id=6472. Example value: "@RG\tID:H0164.2\tPL:ILLUMINA\tPU:H0164ALXX140820.2\tLB:Solexa-272222\tSM:NA12878".
  args:
    type: string
    doc: |
